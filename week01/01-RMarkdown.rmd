# Welcome to MY472 - Data for Data Scientists
# practice new line of code
Before we start our first guided coding session, let's become a bit more familiar with RStudio Server (which we will use to interact with R) and RMarkdown.
